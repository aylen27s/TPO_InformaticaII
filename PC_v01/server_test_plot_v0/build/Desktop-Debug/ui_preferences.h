...
public:
    ...
    void setupUi(QDialog *Preferences)
    {
        ...
        pushButton_aplicar = new QPushButton(horizontalLayoutWidget);
        pushButton_aplicar->setObjectName("pushButton_aplicar");

        horizontalLayout->addWidget(pushButton_aplicar);

        pushButton_cerrar = new QPushButton(horizontalLayoutWidget);
        pushButton_cerrar->setObjectName("pushButton_cerrar");

        horizontalLayout->addWidget(pushButton_cerrar);
        ...
        gridLayout->addWidget(te_t_sample, 5, 1, 1, 1);
